 ...
 const start = (contract?: Contract) =>
  ...
  {editing ? "Save changes" : "Create contract"}
          ...
          <div className={styles.tablePanel}>
            <div className={styles.contractTableHeader}>
